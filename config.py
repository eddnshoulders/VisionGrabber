...
SKR_PORT              = "/dev/serial/by-id/usb-Klipper_stm32f103xe_31FFDB053030473538680543-if00"
SKR_BAUDRATE          = 115200

BUTTON_PORT           = "/dev/ttyButton"
BUTTON_BAUDRATE       = 115200
BUTTON_USB_PRODUCT_ID = 0x1b4f
BUTTON_USB_VENDOR_ID  = 0x9206

SCAN_FEEDRATE         = 2500    # mm/min -- scan step moves
MOVE_FEEDRATE         = 8000    # mm/min -- repositioning moves
BED_FEEDRATE          = 3000    # mm/min -- Z moves

SCAN_X_STEP           = 10      # mm -- X increment between scan points
...
N_FRAMES              = 1       # number of frames to sample for confirmed detection
