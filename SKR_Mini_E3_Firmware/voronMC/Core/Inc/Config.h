...
static constexpr float HOMING_FEEDRATE_FAST_XY   = 1320.0f;  // mm/min
static constexpr float HOMING_FEEDRATE_SLOW_XY   = 1320.0f;   // mm/min
...
static constexpr uint32_t TMC_UART_BAUD        = 40000;

static constexpr uint16_t SERVO_MIN_PULSE_US  = 50;
static constexpr uint16_t SERVO_MAX_PULSE_US  = 3000;
